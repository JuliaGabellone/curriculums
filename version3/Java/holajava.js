<html>
	...
	<body>
		...
		<h6> h6 </h6>
		<hr/>
		<p class="alfa"> Poseen dos pares de alas membranosas cubiertas de <em class="alfa">escamas coloreadas</em>, que utilizan en la termorregulación, <strong>el cortejo y la señalización </strong>. Su aparato bucal es de tipo chupador (véase Insecto) provisto de una larga trompa que se enrolla en espiral (espiritrompa) que permanece enrollada en estado de reposo y que les sirve para libar el néctar de las flores que polinizan. </p>
			<ol>
